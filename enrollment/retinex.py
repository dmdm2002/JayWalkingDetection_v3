...
root = 'D:/Side/2024_Sejoong_Jaywalking/DB/detection/train/'
output = f'{root}/retinex_images'
os.makedirs(output)
...
for name in tqdm.tqdm(image_names):
    ...
    cv2.imwrite(f'{output}/{name}', img_ssr)
# img = cv2.imread('D:/Side/2024_Sejoong_Jaywalking/DB/detection/test/images/CC1522001A_2023-06-08_115453.jpg')
